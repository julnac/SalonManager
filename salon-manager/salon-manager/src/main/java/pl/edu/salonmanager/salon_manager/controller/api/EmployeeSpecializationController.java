...
public class EmployeeSpecializationController {
    ...
    @GetMapping
    @Operation(summary = "Get all specializations (PUBLIC)", description = "Returns list of all employee specializations")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get specialization by ID (PUBLIC)", description = "Returns a single specialization by ID")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete specialization (ADMIN)", description = "Deletes an employee specialization")
